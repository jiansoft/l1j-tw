...
public class Server {
	...
	public static void main(final String[] args) throws Exception {
		...
		l1j.server.L1DatabaseFactory.setDatabaseSettings(Config.DB_DRIVER, Config.DB_URL, Config.DB_LOGIN, Config.DB_PASSWORD);
		l1j.server.L1DatabaseFactory.getInstance();
